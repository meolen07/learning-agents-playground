#!/usr/bin/env python3
"""CLI entry point for Q-learning training."""
...
from src.training.train_q_learning import load_config, train_q_learning
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=Path,
        default=PROJECT_ROOT / "configs" / "frozenlake_q_learning.yaml",
...
def main() -> None:
    ...
    result = train_q_learning(config, verbose=args.verbose)
